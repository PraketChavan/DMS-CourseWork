...
import com.example.breakout_clone.model.sprite.BallModel;
...
public class ImpactHandler {
    ...
    /**
     * Add a PowerUp object as an Impactable object to the list and handles
     * the new objects impacts in the future
    ...
    /**
     * Add a Brick object as an Impactable object to the list and handles the
     * new objects impacts in the future
     ...
     * and handles the new objects impacts in the future
    ...
    /**
     * Add a Ball object as an Impactable object to the  and handles the new
     * objects impacts in the future
