...
abstract public class Brick {
    ...
    public Brick(String name, Point2D pos, Dimension2D size, Color border, Color inner, int strength) {
        ...
        this.setSize(new Dimension2D(size.getWidth(), size.getHeight()));
...
//            Bounds bounds = ((Rectangle) Brick.this.getBrickFace()).getBoundsInParent();
//
...
//            switch (direction) {
//                case LEFT:
//                    start = new Point2D(bounds.getMinX() + bounds.getWidth(), bounds.getMinY());
//                    end = new Point2D(bounds.getMinX() + bounds.getWidth(), bounds.getMinY() + bounds
//                            .getHeight());
