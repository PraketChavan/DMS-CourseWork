 ...
 * @see com.example.migrateFx.controller.game.GameController
 * @see com.example.migrateFx.controller.game.GameEndController
 * @see com.example.migrateFx.controller.game.PauseMenuController
 * @see com.example.migrateFx.controller.game.DebugController
 */
public class GameModel {
     ...
     * @see com.example.migrateFx.controller.sprite.PaddleController
     */
     ...
     * @see com.example.migrateFx.controller.sprite.BallController
     ...
     * {@link com.example.migrateFx.controller.sprite.BallController#setXSpeed(double)} method
    ...
    public boolean islevelComplete() {
        return getBricks().stream().noneMatch(
                brick -> brick.getModel().getName()
                              .compareTo("Unbreakable") != 0);
    }
